    ...
    public partial class FormDanhMucNhanVien : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            if (them)
            {
                try
                {
                    qlnv.ThemNV(txtMaNhanVien.Text,cbbChucVu.Text,txtTen.Text, cbbGioiTinh.Text, int.Parse(txtNamSinh.Text), txtDiaChi.Text, txtDienThoai.Text, txtEmail.Text, txtLuong.Text);
                    Loaddata();
                    qlnv.LayNhanVien(dataGridViewNhanVien);
            ...
            else
            {
                try
                {
                    qlnv.SuaNV(txtMaNhanVien.Text, cbbChucVu.Text, txtTen.Text, cbbGioiTinh.Text, int.Parse(txtNamSinh.Text), txtDiaChi.Text, txtDienThoai.Text, txtEmail.Text, txtLuong.Text);
                    Loaddata();
                    qlnv.LayNhanVien(dataGridViewNhanVien);
                    MessageBox.Show("Lưu thành công");
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string ma = dataGridViewNhanVien.Rows[r].Cells[0].Value.ToString();
